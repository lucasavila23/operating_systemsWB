...
import wbpark.config as config
from wbpark.ui_server  import start_ui_server
from wbpark.clock      import SimClock
from wbpark.park       import Park
from wbpark.visitor    import Visitor
from wbpark.staff      import Staff
from wbpark.events     import EventManager
from wbpark.logger     import log
from wbpark.strategies import ThrillSeekerStrategy, FamilyStrategy, EfficientRouteStrategy
...
def parse_args():
    ...
    p.add_argument(
        ...
        help="Sim speed: sim-minutes per real-second (default: 60)"
    )
    p.add_argument(
...
def main():
    ...
    # ── 1. Simulation clock ───────────────────────────────────────────
    clock = SimClock()
    log("park", "System", "🕙 Clock started — park opens at 10:00", clock)
